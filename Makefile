...
ADDITIONAL_SRC := energy_manager.cpp energy_logger.cpp commands.cpp power_supply.cpp sytare-syscalls/syscalls.cpp sytare-syscalls/peripherals.cpp utils/elfreader.cpp utils/strutils.cpp
