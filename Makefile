...
ADDITIONAL_SRC := mpu.cpp energy_manager.cpp energy_logger.cpp power_supply.cpp sytare-syscalls/syscalls.cpp sytare-syscalls/peripherals.cpp utils/elfreader.cpp
